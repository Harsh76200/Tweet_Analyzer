...
function initializeCharts(data) {
  ...
  if (
    document.getElementById("sentimentPieChart") ||
    document.getElementById("landingSentimentPieChart")
  ) {
    const ctx =
      document.getElementById("sentimentPieChart") ||
      document.getElementById("landingSentimentPieChart");
  ...
  if (
    document.getElementById("candidateBarChart") ||
    document.getElementById("landingCandidateBarChart")
  ) {
    const ctx =
      document.getElementById("candidateBarChart") ||
      document.getElementById("landingCandidateBarChart");
